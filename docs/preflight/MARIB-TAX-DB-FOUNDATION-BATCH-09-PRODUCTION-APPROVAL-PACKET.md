...
**Status:** `REQUIRES_USER_APPROVAL` — preflight complete; apply remains closed. This packet does not authorize Batch 09 apply, Batch 10, Storage operations, or any other migration.
