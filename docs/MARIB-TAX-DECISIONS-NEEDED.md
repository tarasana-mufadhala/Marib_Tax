...
- **Preflight:** `docs/preflight/MARIB-TAX-DB-FOUNDATION-BATCH-09-PRODUCTION-APPLY-PREFLIGHT-01-REPORT.md`
...
- **Baseline at apply:** `da3796bd9af296ac96d0033341eb036a1328f19c`
...
- **Production state:** `PROD-DB-10 = REQUIRES_USER_APPROVAL` — fresh preflight PASS; apply remains closed until a separate explicit approval.
...
- **Preflight:** `docs/preflight/MARIB-TAX-DB-FOUNDATION-BATCH-10-PRODUCTION-APPLY-PREFLIGHT-01-REPORT.md`
- **Approval packet:** `docs/preflight/MARIB-TAX-DB-FOUNDATION-BATCH-10-PRODUCTION-APPROVAL-PACKET.md`
- **Baseline at preflight:** `540403b71c33ce4d641d35eed205689e800b90c7` (PR #73)
...
- **Still forbidden without a new approval:** real `db push`, `--include-all`, migration repair, `db reset --linked`, dashboard SQL, direct `psql`, Storage/gateway/notification operations, Batch 11, or reuse of this preflight as apply approval.
