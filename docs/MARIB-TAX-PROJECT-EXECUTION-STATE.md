...
- API/web/worker/contracts: OpenAPI PASS, typecheck PASS, 60 tests PASS, build PASS, lint PASS, formatting PASS, `git diff --check` PASS for the worker foundation locally.
