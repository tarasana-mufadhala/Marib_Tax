...
- Preflight PR #47 Foundation CI PASS and merged as `6ae2977`. PROD-DB-05 apply still closed.
- Masterdata source authored locally and prepared for PR/CI; no production connection and no Batch 05 apply.
